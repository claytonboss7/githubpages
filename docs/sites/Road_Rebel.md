...
<CustomSite xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <masterLabel>Road Rebel</masterLabel>
    ...
    <siteAdmin>admin@rr.com</siteAdmin>
    <siteGuestRecordDefaultOwner>admin@rr.com</siteGuestRecordDefaultOwner>
    <siteType>ChatterNetwork</siteType>
    <subdomain>voyajer</subdomain>
