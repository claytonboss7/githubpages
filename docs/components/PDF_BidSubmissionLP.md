                ...
                <tr>
                  <td width="20%">
                    <tr>
                      ...
                      <td>
                        <strong style="font-size: 12px">{!productionName}</strong>
                        <br />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <strong style="font-size: 12px">{!productionCompanyName}</strong>
                        <br />
                      </td>
                    </tr>
                    <tr>
                ...
                <tr>
                  <td colspan="2" style="font-size: 10px">
                    <table style="border-spacing: 2px;" width="100%" cellspacing="0" cellpadding="0" border="0">
                      <thead>
                        <tr>
                          <th width="10%" style="background: rgb(198, 208, 203); padding: 5px">
                            DATE IN
                          </th>
                          <th width="10%" style="background: rgb(198, 208, 203); padding: 5px">
                            DATE OUT
                          </th>
                          <th width="10%" style="background: rgb(198, 208, 203); padding: 5px">QTY</th>
                          <th width="30%" style="background: rgb(198, 208, 203); padding: 5px">
                            UNIT TYPE
                          </th>
                          <th width="10%" style="background: rgb(198, 208, 203); padding: 5px">
                            NIGHTS
                          ...
                          <th width="50%" style="background: rgb(198, 208, 203); padding: 5px">
                            SPECIAL NOTES
                          </th>
                        </tr>
                      </thead>
