---
layout: default
title: LightningCallCenterExport
parent: callCenters
---
# Metadata Type
callCenters
...
<CallCenter xmlns="http://soap.sforce.com/2006/04/metadata">
    <adapterUrl>https://roadrebel--rcsfl.visualforce.com/apex/OpenCTIIndex</adapterUrl>
    ...
    <displayName>Cloud Phone App v2</displayName>
    ...
    <sections>
        <items>
            ...
            <value>https://roadrebel--rcsfl.visualforce.com/apex/OpenCTIIndex</value>
        </items>
        <items>
