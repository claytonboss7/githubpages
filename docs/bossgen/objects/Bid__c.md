...
<CustomField xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>Bid is active when bid is sent but not yet submitted by vendor</description>
    <externalId>false</externalId>
    <formula>NOT( OR( Is_Bid_Submitted_By_Vendor__c, Sold_out__c, ISPICKVAL(Status__c, &apos;Sold Out / Not Bidding&apos;), AND(ISNULL(Bid_Last_Sent_Date__c), NOT(ISPICKVAL(Status__c, &apos;Sent&apos;)))))</formula>
    <inlineHelpText>Bid is active when bid is sent but not yet submitted by vendor</inlineHelpText>
...
<?xml version="1.0" encoding="UTF-8"?>
<CustomField xmlns="http://soap.sforce.com/2006/04/metadata">
    <fullName>Housing_Rate__c</fullName>
    <externalId>false</externalId>
    <formula>Housing__r.Rate__c</formula>
    <formulaTreatBlanksAs>BlankAsZero</formulaTreatBlanksAs>
    <label>Housing Rate</label>
    <precision>18</precision>
    <required>false</required>
    <scale>2</scale>
    <trackHistory>false</trackHistory>
...
```
### Create_Bid_Memorial_PDF__c

```
<?xml version="1.0" encoding="UTF-8"?>
<CustomField xmlns="http://soap.sforce.com/2006/04/metadata">
    <fullName>Create_Bid_Memorial_PDF__c</fullName>
    <defaultValue>false</defaultValue>
    <externalId>false</externalId>
    <label>Create Bid Memorial PDF</label>
    <trackFeedHistory>false</trackFeedHistory>
    <trackHistory>false</trackHistory>
    <trackTrending>false</trackTrending>
    <type>Checkbox</type>
...
```
### Housing_Unit_Type__c

```
<?xml version="1.0" encoding="UTF-8"?>
<CustomField xmlns="http://soap.sforce.com/2006/04/metadata">
    <fullName>Housing_Unit_Type__c</fullName>
    <externalId>false</externalId>
    <formula>TEXT(Housing__r.Unit_Type__c)</formula>
    <formulaTreatBlanksAs>BlankAsZero</formulaTreatBlanksAs>
    <label>Housing Unit Type</label>
    <required>false</required>
    <trackHistory>false</trackHistory>
    <trackTrending>false</trackTrending>
    <type>Text</type>
...
```
### Is_Bid_Submitted_By_Vendor__c

```
<?xml version="1.0" encoding="UTF-8"?>
<CustomField xmlns="http://soap.sforce.com/2006/04/metadata">
    <fullName>Is_Bid_Submitted_By_Vendor__c</fullName>
    <description>To specify if bid has already been submitted.</description>
    <externalId>false</externalId>
    <formula>OR(NOT(ISBLANK(responseVendorEmail__c)), NOT(ISBLANK(responseVendorName__c)), NOT(ISBLANK(responseVendorPhone__c)), NOT(ISBLANK(responseVendorTitle__c)))</formula>
    <inlineHelpText>True when bid has already been submitted by  vendor</inlineHelpText>
    <label>Is Bid Submitted By Vendor</label>
    <trackHistory>false</trackHistory>
    <trackTrending>false</trackTrending>
    <type>Checkbox</type>
</CustomField>
...
```
### Memorialization_URL__c

```
<?xml version="1.0" encoding="UTF-8"?>
<CustomField xmlns="http://soap.sforce.com/2006/04/metadata">
    <fullName>Memorialization_URL__c</fullName>
    <externalId>false</externalId>
    <label>Memorialization URL</label>
    <required>false</required>
    <trackFeedHistory>false</trackFeedHistory>
    <trackHistory>false</trackHistory>
    <trackTrending>false</trackTrending>
...
```
### Bid_Last_Sent_Date__c

```
<?xml version="1.0" encoding="UTF-8"?>
<CustomField xmlns="http://soap.sforce.com/2006/04/metadata">
    <fullName>Bid_Last_Sent_Date__c</fullName>
    <externalId>false</externalId>
    <label>Bid Last Sent Date</label>
    <required>false</required>
    <trackFeedHistory>false</trackFeedHistory>
    <trackHistory>false</trackHistory>
    <trackTrending>false</trackTrending>
...
<?xml version="1.0" encoding="UTF-8"?>
<CustomField xmlns="http://soap.sforce.com/2006/04/metadata">
    <fullName>Housing_Unit__c</fullName>
    <externalId>false</externalId>
    <formula>Housing__r.Unit__c</formula>
    <formulaTreatBlanksAs>BlankAsZero</formulaTreatBlanksAs>
...
<?xml version="1.0" encoding="UTF-8"?>
<CustomField xmlns="http://soap.sforce.com/2006/04/metadata">
    <fullName>Production_Name__c</fullName>
    <externalId>false</externalId>
    <formula>Production__r.Name</formula>
    <formulaTreatBlanksAs>BlankAsZero</formulaTreatBlanksAs>
