...
<Flow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>Conga Sign transaction cancellation</description>
    <interviewLabel>Conga_Sign_Transaction_Cancellation-1_InterviewLabel</interviewLabel>
    <label>Conga Sign Transaction Cancellation</label>
