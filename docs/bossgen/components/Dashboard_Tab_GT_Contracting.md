---
layout: default
title: Dashboard_Tab_GT_Contracting
parent: components
---
# Metadata Type
components
...
<apex:component layout="block" controller="Dashboard_Tab_Contracting" allowDML="true">
    ...
    <div class="expand" style="margin-bottom: 0.5em;">
        <div class="card" style="padding-bottom: 1em;margin-bottom:10px;">
            <div class="row" style="align-items: flex-end; padding: 0 1em 1em;">
                <div class="col-md-2">
                    <label for="contractSearchBoxStartDate">Start Date</label><br/>
                ...
                <div class="col-md-2">
                    <label for="contractSearchBoxEndDate">End Date</label><br/>
                    <!--<div class="input-group input-group-sm">
                ...
                <thead class="theadResult">
                    <tr>
                        <th scope="col" width="10%">
                            <a href="javascript:void(0);" style="color: #495057;" onclick="sortBidContracts('GT__r.Start_Date__c','{!orderOrientationBidContract}');">
                                <span style="float:left;">Start Date</span>
                                <i class="fas fa-sort-down" style="float:left;margin-top:2px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'GT__r.Start_Date__c',orderOrientationBidContract == 'DESC'),'','display:none;')}"></i>
                                <i class="fas fa-sort-up" style="float:left;margin-top:7px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'GT__r.Start_Date__c',orderOrientationBidContract == 'ASC'),'','display:none;')}"></i>
                            </a>
                        </th>
                        <th scope="col" width="10%">
                            <a href="javascript:void(0);" style="color: #495057;" onclick="sortBidContracts('GT__r.End_Date__c','{!orderOrientationBidContract}');">
                                <span style="float:left;">End Date</span>
                                <i class="fas fa-sort-down" style="float:left;margin-top:2px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'GT__r.End_Date__c',orderOrientationBidContract == 'DESC'),'','display:none;')}"></i>
                                <i class="fas fa-sort-up" style="float:left;margin-top:7px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'GT__r.End_Date__c',orderOrientationBidContract == 'ASC'),'','display:none;')}"></i>
                            </a>
                        </th>
                        <th scope="col" width="20%">
                            <a href="javascript:void(0);" style="color: #495057;" onclick="sortBidContracts('GT__r.Description__c','{!orderOrientationBidContract}');">
                                <span style="float:left;">Description</span>
                                <i class="fas fa-sort-down" style="float:left;margin-top:2px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'GT__r.Description__c',orderOrientationBidContract == 'DESC'),'','display:none;')}"></i>
                                <i class="fas fa-sort-up" style="float:left;margin-top:7px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'GT__r.Description__c',orderOrientationBidContract == 'ASC'),'','display:none;')}"></i>
                            </a>
                        </th>
                        <th scope="col" width="15%">
                            <a href="javascript:void(0);" style="color: #495057;" onclick="sortBidContracts('GT__r.Service_Type_Text__c','{!orderOrientationBidContract}');">
                                <span style="float:left;">Service Type</span>
                                <i class="fas fa-sort-down" style="float:left;margin-top:2px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'GT__r.Service_Type_Text__c',orderOrientationBidContract == 'DESC'),'','display:none;')}"></i>
                                <i class="fas fa-sort-up" style="float:left;margin-top:7px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'GT__r.Service_Type_Text__c',orderOrientationBidContract == 'ASC'),'','display:none;')}"></i>
                            </a>
                        </th>
                        <th scope="col" width="20%">
                        ...
                        <th scope="col" width="10%">
                            <a href="javascript:void(0);" style="color: #495057;" onclick="sortBidContracts('GT__r.Group_Type__c','{!orderOrientationBidContract}');">
                                <span style="float:left;">Group</span>
                                <i class="fas fa-sort-down" style="float:left;margin-top:2px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'GT__r.Group_Type__c',orderOrientationBidContract == 'DESC'),'','display:none;')}"></i>
                                <i class="fas fa-sort-up" style="float:left;margin-top:7px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'GT__r.Group_Type__c',orderOrientationBidContract == 'ASC'),'','display:none;')}"></i>
                            </a>
                        </th>
                        <th scope="col" width="15%">
                            ...
                            <td width="10%">
                                <span class="show-data">
                                    <a href="javascript:void(0);" onclick="viewBidContracted('{!bid.bidId}','{!bid.bidName}','{!bid.parentId}')">
                                        <apex:outputField value="{!bid.gtTrip.Start_Date__c}"/>
                                    </a>
                                </span>
                            </td>
                            <td width="10%">
                                <span class="show-data">
                                    <apex:outputField value="{!bid.gtTrip.End_Date__c}"/>
                                </span>
                            </td>
                            <td width="20%">
                                <span class="show-data">{!bid.description}</span>
                            </td>
                            <td width="15%">
                                <span class="show-data">{!bid.serviceType}</span>
                            </td>
                            <td width="20%">
                                <span class="show-data">
    ...
    <apex:outputPanel id="bidContractInformation" layout="block">
        <apex:outputPanel rendered="{!IF(vfpConfiguration.bidId=='',false,true)}">
            ...
            <apex:outputPanel id="bidContractTabs" layout="block">
                <div class="slds-tabs_scoped">
                    <ul class="slds-tabs_scoped__nav" role="tablist">
                        ...
                        <li class="slds-tabs_scoped__item {!IF(tabContractDefault == 'closeout','slds-is-active','')}" title="Close Out" role="presentation">
                            <a class="slds-tabs_scoped__link" href="#contract-closeout" onclick="loadTabContractContent('closeout');" role="tab" tabindex="{!IF(tabContractDefault == 'closeout','0','-1')}" aria-selected="{!IF(tabContractDefault == 'closeout','true','false')}" aria-controls="contract-closeout" id="contract-closeout__item">
                                <span><i class="fas fa-sign-out-alt"></i> Close Out</span>
                            </a>
                        </li>
                    </ul>
                    <div class="slds-tabs_scoped__content slds-show" role="tabpanel">
                        <div id="subTabSelected" style="position: relative; margin: -1em;">
                            ...
                            <div style="padding: 1em;">
                                ...
                                <c:Dashboard_Tab_Close_Out rendered="{!IF(tabContractDefault == 'closeout',true,false)}" variables="{!vfpConfiguration}"  />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog" style="min-width: 75em;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Ground Travel Contracting Documents</h4>
    ...
    <apex:actionFunction name="loadContractingDocumentsPanel" status="loading" reRender="contractingDocuments" oncomplete="openModal('myModalBidDocuments');">
        <apex:param assignTo="{!loadDocuments}" name="loadDocuments" value="true" />
    </apex:actionFunction>
    <apex:actionFunction name="closeContractingDocumentsPanel" status="loading" reRender="contractingDocuments,bidContractTabs" oncomplete="closeModal('myModalBidDocuments');">
    ...
    <apex:actionFunction action="{!searchBidContracts}" name="searchBidContractingJs" status="loading" reRender="bidContractList" oncomplete="verifyButtonsListContract();">
        ...
        <apex:param assignTo="{!orderFieldBidContract}" name="orderFieldBidContract" value="GT__r.Start_Date__c" />
