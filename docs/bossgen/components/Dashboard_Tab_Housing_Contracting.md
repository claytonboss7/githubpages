---
layout: default
title: Dashboard_Tab_Housing_Contracting
parent: components
---
# Metadata Type
components
...
# Filename 
Dashboard_Tab_Housing_Contracting
...
<apex:component layout="block" controller="Dashboard_Tab_Contracting" allowDML="true">
    ...
    <div class="expand" style="margin-bottom: 0.5em;">
            ...
            <div class="row" style="align-items: flex-end; padding: 0 1em 1em;">
                <div class="col-md-2">
                    ...
                    <!--<div class="input-group input-group-sm">
                        <input type="text" id="contractSearchBoxStartDate" placeholder="mm/dd/yyyy" value="{!searchBoxWrapper.startDate}" class="form-control" onfocus="DatePicker.pickDate(true,'contractSearchBoxStartDate',false);" />
                        <div class="input-group-append"><div class="input-group-text"><i class="far fa-calendar-alt"></i></div></div>
                    </div>-->
                ...
                <div class="col-md-2">
                    ...
                    <!--<div class="input-group input-group-sm">
                        <input type="text" id="contractSearchBoxEndDate" placeholder="mm/dd/yyyy" value="{!searchBoxWrapper.endDate}" class="form-control" onfocus="DatePicker.pickDate(true,'contractSearchBoxEndDate',false);" />
                        <div class="input-group-append"><div class="input-group-text"><i class="far fa-calendar-alt"></i></div></div>
                    </div>-->
                ...
                <div class="col-md-3">
                    <label>Vendor</label>
                    <!--<div class="input-search-wrapper"><input type="text" id="contractVendor" class="form-control form-control-sm input-search" placeholder="Vendor" /></div>-->
                ...
                <div class="col-md-2">
                    <label>City</label>
                    <!--<div class="input-search-wrapper"><input type="text" id="contractCity" class="form-control form-control-sm input-search" placeholder="City" /></div>-->
                ...
                <div class="col-md-3">
                    <!--<apex:selectList id="contractSearchBoxStatusValue" value="{!searchBoxWrapper.statusValue}" size="1" styleClass="form-control form-control-sm">
            ...
            <div class="row" style="align-items: center;">
                <div class="col-md-9">
                    <span style="margin-left: 1rem;">
                        <apex:inputCheckbox value="{!searchBoxWrapper.isPriorTrip}" id="contractSearchBoxIsPriorTrip" /><label for="contractSearchBoxIsPriorTrip">Show Prior Trips</label>
                    </span>
                    <span style="margin-left: 1rem;">
                        <apex:inputCheckbox value="{!searchBoxWrapper.isContractedOnOwn}" id="contractSearchBoxIsContractedOnOwn" /><label for="contractSearchBoxIsContractedOnOwn">Show Contracted on own</label>
                    </span>
                    <span style="margin-left: 1rem;">
                        <apex:inputCheckbox value="{!searchBoxWrapper.isCancelled}" id="contractSearchBoxIsCancelled" /><label for="contractSearchBoxIsCancelled">Show Cancelled</label>
                    </span>
                </div>
                <div class="col-md-3">
        ...
        <apex:outputPanel id="bidContractList" layout="block">
            ...
            <table class="table tableResult table-sm" style="margin-top:10px; margin-bottom:0; border-bottom: 1px solid #dee2e6;">
                <thead class="theadResult">
                    <tr>
                        <th scope="col" width="10%">
                            <a href="javascript:void(0);" style="color: #495057;" onclick="sortBidContracts('startDate','{!orderOrientationBidContract}');">
                                <span style="float:left;">Check In</span>
                                <i class="fas fa-sort-down" style="float:left;margin-top:2px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'startDate',orderOrientationBidContract == 'DESC'),'','display:none;')}"></i>
                                <i class="fas fa-sort-up" style="float:left;margin-top:7px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'startDate',orderOrientationBidContract == 'ASC'),'','display:none;')}"></i>
                            </a>
                        </th>
                        <th scope="col" width="10%">
                            <a href="javascript:void(0);" style="color: #495057;" onclick="sortBidContracts('endDate','{!orderOrientationBidContract}');">
                                <span style="float:left;">Check Out</span>
                                <i class="fas fa-sort-down" style="float:left;margin-top:2px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'endDate',orderOrientationBidContract == 'DESC'),'','display:none;')}"></i>
                                <i class="fas fa-sort-up" style="float:left;margin-top:7px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'endDate',orderOrientationBidContract == 'ASC'),'','display:none;')}"></i>
                            </a>
                        </th>
                        ...
                        <th scope="col" width="15%">
                            <a href="javascript:void(0);" style="color: #495057;" onclick="sortBidContracts('serviceType','{!orderOrientationBidContract}');">
                                <span style="float:left;">City</span>
                                <i class="fas fa-sort-down" style="float:left;margin-top:2px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'serviceType',orderOrientationBidContract == 'DESC'),'','display:none;')}"></i>
                                <i class="fas fa-sort-up" style="float:left;margin-top:7px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'serviceType',orderOrientationBidContract == 'ASC'),'','display:none;')}"></i>
                            </a>
                        </th>
                        <th scope="col" width="20%">
                            <a href="javascript:void(0);" style="color: #495057;" onclick="sortBidContracts('vendor','{!orderOrientationBidContract}');">
                                <span style="float:left;">Vendor</span>
                                <i class="fas fa-sort-down" style="float:left;margin-top:2px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'vendor',orderOrientationBidContract == 'DESC'),'','display:none;')}"></i>
                                <i class="fas fa-sort-up" style="float:left;margin-top:7px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'vendor',orderOrientationBidContract == 'ASC'),'','display:none;')}"></i>
                            </a>
                        </th>
                        <th scope="col" width="10%">
                            <a href="javascript:void(0);" style="color: #495057;" onclick="sortBidContracts('groupName','{!orderOrientationBidContract}');">
                                <span style="float:left;">Group</span>
                                <i class="fas fa-sort-down" style="float:left;margin-top:2px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'groupName',orderOrientationBidContract == 'DESC'),'','display:none;')}"></i>
                                <i class="fas fa-sort-up" style="float:left;margin-top:7px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'groupName',orderOrientationBidContract == 'ASC'),'','display:none;')}"></i>
                            </a>
                        </th>
                        <th scope="col" width="15%">
                            <a href="javascript:void(0);" style="color: #495057;" onclick="sortBidContracts('status','{!orderOrientationBidContract}');">
                                <span style="float:left;">Status</span>
                                <i class="fas fa-sort-down" style="float:left;margin-top:2px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'status',orderOrientationBidContract == 'DESC'),'','display:none;')}"></i>
                                <i class="fas fa-sort-up" style="float:left;margin-top:7px;margin-left:5px;{!IF(AND(orderFieldBidContract == 'status',orderOrientationBidContract == 'ASC'),'','display:none;')}"></i>
                            </a>
                        </th>
                    </tr>
                </thead>
                    ...
                    <apex:repeat value="{!bidContractsList}" var="bid">
                        <tr>
                                ...
                                <span class="show-data">
                                    <a href="javascript:void(0);" onclick="viewBidContracted('{!bid.bidId}','{!bid.bidName}','{!bid.parentId}')">
                                        <apex:outputText value="{0, date, MM'/'dd'/'yyyy}">
                                            <apex:param value="{!bid.startDate}" />
                                        </apex:outputText>
                                    </a>
                                </span>
                            </td>
                            <td width="10%">
                                <span class="show-data">
                                    <apex:outputText value="{0, date, MM'/'dd'/'yyyy}">
                                        <apex:param value="{!bid.endDate}" />
                                    </apex:outputText>
                                </span>
                            </td>
                            <td width="20%">
                                <span class="show-data">{!bid.venue}</span>
                            </td>
                            <td width="15%">
                                <span class="show-data">{!bid.city}</span>
                            </td>
                            <td width="20%">
                                <span class="show-data">
                            ...
                            <td width="10%">
                                <span class="show-data">{!bid.groupName}</span>
                            </td>
                            <td width="15%">
    ...
    <apex:outputPanel id="bidContractInformation" layout="block" style="{!IF(vfpConfiguration.bidId='','display: none;','')}">
                ...
                <div class="col" style="padding: 0 0.5em;">
                    <div class="card darkCard" style="padding: 0.5em; height: 100%;">
                        <div class="row">
                            ...
                            <div class="col">{!bidSelected.GT__r.Description__c}</div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col"><apex:outputText value="{0, date, dd'-'MMM'-'yyyy}"><apex:param value="{!bidSelected.GT__r.Start_Date__c}" /></apex:outputText><span style="font-weight:bold;"><apex:outputText value="{0, date, ' 'EEEE}"> <apex:param value="{!bidSelected.GT__r.Start_Date__c}" /> </apex:outputText></span></div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">End Date:</div>
                            <div class="col"><apex:outputText value="{0, date, dd'-'MMM'-'yyyy}"><apex:param value="{!bidSelected.GT__r.End_Date__c}" /></apex:outputText><span style="font-weight:bold;"><apex:outputText value="{0, date, ' 'EEEE}"> <apex:param value="{!bidSelected.GT__r.End_Date__c}" /> </apex:outputText></span></div>
                        </div>
                    </div>
                </div>
                <div class="col" style="padding: 0 0.5em;">
                    <div class="card darkCard" style="padding: 0.5em; height: 100%;">
                        ...
                        <div class="row">
                            <div class="col-md-4">GT Coordinator:</div>
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col-md-4">GT Backend Coordinator:</div>
                            <div class="col">
                    ...
                    <div class="card darkCard" style="padding: 0.5em; height: 100%;">
                        ...
                        <div class="row">
                            <div class="col" style="font-size: 0.85rem; display: flex;">
                                ...
                                <button class="btn btn-secondary btn-sm btn-custom" onclick="searchBid('{!vfpConfiguration.bidName}');" type="button" style="margin-left: 1em;"><i class="far fa-check-square"></i> Bid Details</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="slds-tabs_scoped__content slds-show" role="tabpanel">
                    <div id="subTabSelected" style="position: relative; margin: -1em;">
                        ...
                        <div style="padding: 1em;">
                            ...
                            <!--<c:Dashboard_Tab_Contract_GCQ rendered="{!IF(tabContractDefault == 'gcq',true,false)}" variables="{!vfpConfiguration}" clientId="{!contactClientValue}" />-->
                        </div>
                    </div>
                </div>
            </div>
        </apex:outputPanel>
        <div class="modal fade" id="myModalContractingGCQ" role="dialog" style="padding-right: 18px;">
            <div class="modal-dialog" style="min-width: 75em;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Housing Contracting Department</h4>
                    ...
                    <apex:outputPanel id="contractingDocuments" layout="block" styleClass="modal-body">
                        <c:Dashboard_Dialog_Documents rendered="{!loadDocuments}" recordId="{!vfpConfiguration.bidId}" parentSObject="{!vfpConfiguration.parentSObject}" contract="true" />
                    </apex:outputPanel>
                </div>
            </div>
        </div>
    </apex:outputPanel>
    <apex:actionFunction name="loadBidContractsJs" action="{!loadBidContracts}" status="loading" reRender="bidContractList,bidContractInformation" />
    ...
    <apex:actionFunction name="loadContractingDocumentsPanel" status="loading" reRender="contractingDocuments" oncomplete="openModal('myModalContractingGCQ');">
        <apex:param assignTo="{!loadDocuments}" name="loadDocuments" value="true" />
    </apex:actionFunction>
    <apex:actionFunction name="closeContractingDocumentsPanel" status="loading" reRender="contractingDocuments,bidContractTabs" oncomplete="closeModal('myModalContractingGCQ');">
    ...
    <apex:actionFunction action="{!searchBidContracts}" name="searchBidContractingJs" status="loading" reRender="bidContractList">
    ...
    <apex:actionFunction action="{!searchBidContracts}" name="sortBidContractsJs" status="loading" reRender="bidContractList">
    ...
    <apex:actionFunction action="{!changeFinalStatus}" name="changeFinalStatusJs" status="loading" reRender="noneRender,bidContractList" oncomplete="loadBidContractsJs();loadTracesJs();searchBidContractingJs();">
            ...
            $('.gtcontract-vendor').autocomplete({
                lookup: function (query, done) {
                    Visualforce.remoting.Manager.invokeAction(
                        '{!$RemoteAction.Dashboard_Tab_Contracting.searchAccount}',query,'Ground Travel Vendor',
    ...
    function setInputContractCity(){
        if(createAutocompleteContractCity == false){
            ...
            $('.gtcontract-city').autocomplete({
                lookup: function (query, done) {
                    Visualforce.remoting.Manager.invokeAction(
                        '{!$RemoteAction.Dashboard_Tab_Contracting.searchCity}',query,
                        function(result, event){
                            if (event.status) {
                                var t1 = result;
                                var results = t1.replace(/(&quot\;)/g,"\"").replace(/&#39;/g,"'").replace(/(&amp\;)/g,"&");
    ...
    function searchBidContracting(){
        console.log('in search bid contracting');
        ...
        var show_prior = $("input[id$=housingContractsShowPrior]").prop("checked");
    ...
    function changeFinalStatus(val){
        console.log('in changeFinalStatus bid final status');
        ...
        console.log('in search bid final status');
    }
    </script>
</apex:component>
```
